...
from ordc.settings import DEBUG
    ...
    "handlers": {
        "fileHandler": {
            ...
            "filename": os.path.join(
                BASE_DIR, "auction.log"
            ),  # '/Users/upendra/Desktop/log/debug.log',
        ...
        "apiFileHandler": {
            ...
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(BASE_DIR, "auction-api.log"),
            "maxBytes": 10 * 10 ** 6,  # will 10 MB do?
            "backupCount": 10,  # keep this many extra historical files
            "formatter": "timestampthread",
        },
        "djangoFileHandler": {
            ...
            "level": min_level,  # this level or higher goes to the log file
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(BASE_DIR, "auction-django-file.log"),
            "maxBytes": 10 * 10 ** 6,  # will 10 MB do?
            "backupCount": 10,  # keep this many extra historical files
            "formatter": "timestampthread",
        },
