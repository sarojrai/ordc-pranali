...
function centerPopupIncludeConBags(connection_id){
      $("#popupContact").css({
                "position": "absolute",
                "top": 122,
                "left": 204,
...
$("#popupContact").load("/service-centre/include_con_bags/"+connection_id+"/")
}

function centerPopupDelinkConBags(connection_id){
      $("#popupContact").css({
                "position": "absolute",
                "top": 122,
                "left": 204,
...
$("#popupContact").load("/service-centre/delink_con_bags/"+connection_id+"/")
...
function centerPopupUnloadVehicleHub(trip_id){
...
$("#popupContact").load("/hub/unload_bag/"+trip_id+"/")
}

function centerPopupUnloadVehicleDel(trip_id){
...
$("#popupContact").load("/delivery/unload_bag/"+trip_id+"/")
}


function centerPopupLoadShortExcessDel(trip_id){
        ...
        $("#backgroundPopup").css({});
    $("#popupContact").load("/coloader/short_excess_del/"+trip_id+"/")
}



function centerPopupLoadShortExcessHub(trip_id){
        ...
        $("#backgroundPopup").css({});
    $("#popupContact").load("/coloader/short_excess_hub/"+trip_id+"/")
}


function centerPopupLoadVehicleDel(trip_id){
        ...
        $("#backgroundPopup").css({});
    $("#popupContact").load("/coloader/load_del/"+trip_id+"/")
}


function centerPopupConnection(tp_id){
        ...
        $("#backgroundPopup").css({});
    $("#popupContact").load("/service-centre/run/"+tp_id+"/")
}

function centerPopupGenerateRunChallan(trip_id){
...
$("#popupContact").load("/coloader/generate_run_challan/"+trip_id+"/")
}
...
$(".delink_shipment").live("click",function(){
   ...
   $(".add_shipment").click(function(){
	...
	$(".include_con_bags").live("click",function(){
            var connection_id = $(this).attr("connection_id");
                centerPopupIncludeConBags(connection_id);
                loadPopup();
        });  


        $(".delink_con_bags").live("click",function(){
            var connection_id = $(this).attr("connection_id");
                centerPopupDelinkConBags(connection_id);
                loadPopup();
        });
	...
	$(".gen_challan").live("click",function(){
        ...
        $("#gen_challan_nimda").live("click",function(){
            var connection_id = document.getElementById("connection_value").value;
                centerPopupGenerateChallan(connection_id);
                loadPopup();
        });
...
//      alert("hi");
	...
	$(".unload_hub").live("click",function(){
            var trip_id = $(this).attr("trip_id");
                centerPopupUnloadVehicleHub(trip_id);
                loadPopup();
        });

	$(".unload_del").live("click",function(){
            var trip_id = $(this).attr("trip_id");
		//alert(trip_id);
                centerPopupUnloadVehicleDel(trip_id);
                loadPopup();
        });


       $(".short-excess-del").live("click",function(){
            var trip_id = $(this).attr("trip_id");
                centerPopupLoadShortExcessDel(trip_id);
                loadPopup();
                //alert(tp_id);
        });


      $(".short-excess-hub").live("click",function(){
            var trip_id = $(this).attr("trip_id");
                centerPopupLoadShortExcessHub(trip_id);
                loadPopup();
                //alert(tp_id);
        });


      $(".load_del").live("click",function(){
            var trip_id = $(this).attr("trip_id");
                centerPopupLoadVehicleDel(trip_id);
                loadPopup();
                //alert(tp_id);
        });
     ...
     $(".connection").live("click",function(){
            var tp_id = $(this).attr("tp_id");
                centerPopupConnection(tp_id);
                loadPopup();
 		//alert(tp_id);
        });
     $(".gen_run_challan").live("click",function(){
            var trip_id = $(this).attr("trip_id");
                centerPopupGenerateRunChallan(trip_id);
                loadPopup();
        });
});
